...
INMET obtidas através do [seoma.rs@inmet.gov.br](seoma.rs@inmet.gov.br)  para os estados do Sul do Brasil são disponibilizados em formato texto (ASCII). É comum em dados 
...
adequada (e.g. `date`) e as variáveis meteorológicas (colunas) preenchidas com um valor definido para identificar dados faltantes (e.g: `NA`, `-9999`). 
