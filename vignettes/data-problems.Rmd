...
knitr::kable(head(hdata[, 1:10]))
knitr::kable(tail(hdata[, 1:10]))
```
...
```{r, fig.align='center', fig.height=9, fig.width=6, fig.cap = "Séries horárias de Precipitação."}
library(openair)
